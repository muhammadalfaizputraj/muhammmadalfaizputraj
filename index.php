...
<body>
    ...
    <div class="slider">
        <div class="sliderWrapper">
            <div class="sliderItem">
                ...
                <h2 class="sliderPrice">IDR 1.800.000</h2>
                <a href="#product">
            ...
            <div class="sliderItem">
                ...
                <h2 class="sliderPrice">IDR 2.300.000</h2>
                <a href="#product">
                    <button class="buyButton">BUY NOW!</button>
                </a>
            </div>
            <div class="sliderItem">
                ...
                <h2 class="sliderPrice">IDR 1.700.000</h2>
                <a href="#product">
                    <button class="buyButton">BUY NOW!</button>
                </a>
            </div>
            <div class="sliderItem">
                ...
                <h2 class="sliderPrice">IDR 2.000.000</h2>
                <a href="#product">
                    <button class="buyButton">BUY NOW!</button>
                </a>
            </div>
            <div class="sliderItem">
                ...
                <h2 class="sliderPrice">IDR 1.550.000</h2>
                <a href="#product">
                    <button class="buyButton">BUY NOW!</button>
                </a>
            </div>
    ...
    <div class="product" id="product">
        ...
        <div class="productDetails">
            ...
            <p class="productDesc">the first nike shoe series to carry nike air technology with the air sole unit
            this technology uses airbags on the back sole for a softer foot cushion.
            </p>
            <div class="colors">
                <div class="color"></div>
                <div class="color"></div>
    ...
    <footer>
        ...
        <div class="footerRight">
            ...
            <div class="footerRightMenu">
                ...
                <div class="fIcons">
                    <a href="https://www.facebook.com/m.nandra.9?mibextid=ZbWKwL">
                    <img src="./img/facebook.png" alt="" class="fIcon"></a>
                    <img src="./img/twitter.png" alt="" class="fIcon">
                    <a href="https://www.instagram.com/rifqi.yd/?next=%2F&hl=id">
                    <img src="./img/instagram.png" alt="" class="fIcon"></a>
